...
# standalone/cron-запуск НЕ наследует Environment= из systemd-юнита бота —
# задаём те же пути по умолчанию, чтобы config открыл ту же боевую базу и папку web.
os.environ.setdefault("DATA_DIR", "/opt/habar/data")
os.environ.setdefault("WEB_DIR", "/opt/habar/web")
